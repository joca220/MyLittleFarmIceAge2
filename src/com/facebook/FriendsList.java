...
import de.softgames.en.mylittlefarm2.R;
            ...
            new AlertDialog.Builder(this).setTitle(R.string.post_on_wall_title)
                    ...
                    .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            params.putString("description", "Rebuild the little farm of your grandfather and take it back to the glory of the old days! Together we can grow better crops, keep more animals and earn more money! It is awesome and completely free!");
                            params.putString("picture", Utility.HACK_ICON_URL);
                            params.putString("link", "http://goo.gl/8dOrx3");
                            params.putString("name", "Please help me to rebuild my farm!");
