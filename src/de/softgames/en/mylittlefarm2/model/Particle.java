...
public class Particle {
    ...
    public static final int DEFAULT_LIFETIME = 50; // play with this
    public static final int MAX_DIMENSION = 5; // the maximum width or height
    public static final int MAX_SPEED = 20; // maximum speed (per update)
    ...
    public void update() {
        if (this.state != STATE_DEAD) {
            ...
            if (a <= 0) { // if reached transparency kill the particle
                ...
                this.age += 2; // increase the age of the particle
                // this.widht *= 1.05;
                // this.height *= 1.05;
            }
    ...
    public void update(Rect container) {
        ...
        /*
         * if (this.isAlive()) { if (this.x <= container.left || this.x >=
         * container.right - this.widht) { this.xv *= -1; } // Bottom is 480 and
         * top is 0 !!! if (this.y <= container.top || this.y >=
         * container.bottom - this.height) { this.yv *= -1; } }
         */
        update();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        // canvas.dra wRect(this.x, this.y, this.x + this.widht, this.y +
        // this.height, paint);
        canvas.drawBitmap(Constants.starAnimation, this.x, this.y, null);
    }
